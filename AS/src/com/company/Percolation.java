...
public class Percolation {
    ...
    public void open(int i, int j) { // open site (row i, column j) if it is not open already
        //check if node is open, if not then change value to open.
    }
    ...
    public boolean percolates() { // does the system percolate?
        //check if  phantom node at top connects to phantom bottom node? Also be conscious of backwash
        return false;
    }


    private int xyTo1d(int x, int y) { //convert 2d grid to 1d number
